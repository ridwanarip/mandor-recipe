...
import com.mandor.domain.Difficulty;
import com.mandor.domain.Ingredient;
import com.mandor.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes() {
		...
		guaRecipe.getIngredient().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("Kosher salt", new BigDecimal(.5), teaSpoonUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("cilantro", new BigDecimal(2), tableSpoonUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, guaRecipe));
		guaRecipe.getIngredient().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(.5), eachUom, guaRecipe));
		...
		tacosRecipe.getIngredient().add(new Ingredient("clove garlic, chopped", new BigDecimal(1), eachUom, tacosRecipe));
		tacosRecipe.getIngredient().add(new Ingredient("finely grated orange zest", new BigDecimal(1), tableSpoonUom, tacosRecipe));
		...
		tacosRecipe.getIngredient().add(new Ingredient("medium ripe avocados, sliced", new BigDecimal(2), eachUom, tacosRecipe));
